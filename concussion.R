...
Patriots2018concussions <- Patriots2018[grep("Concussion", Patriots2018$injury),]
...
# removes all rows that dont include a concussion injury
Dolphins2018concussions <- Dolphins2018[grep("Concussion", Dolphins2018$injury),]
...
# removes all rows that dont include a concussion injury
Bills2018concussions <- Bills2018[grep("Concussion", Bills2018$injury),]
...
# removes all rows that dont include a concussion injury
Jets2018concussions <- Jets2018[grep("Concussion", Jets2018$injury),]
Jets2018concussions
...
# removes all rows that dont include a concussion injury
Texans2018concussions <- Texans2018[grep("Concussion", Texans2018$injury),]
...
# removes all rows that dont include a concussion injury
Colts2018concussions <- Colts2018[grep("Concussion", Colts2018$injury),]
...
# removes all rows that dont include a concussion injury
Titans2018concussions <- Titans2018[grep("Concussion", Titans2018$injury),]
...
# removes all rows that dont include a concussion injury
Jaguars2018concussions <- Jaguars2018[grep("Concussion", Jaguars2018$injury),]
...
# removes all rows that dont include a concussion injury
Ravens2018concussions <- Ravens2018[grep("Concussion", Ravens2018$injury),]
...
# removes all rows that dont include a concussion injury
Steelers2018concussions <- Steelers2018[grep("Concussion", Steelers2018$injury),]
...
# removes all rows that dont include a concussion injury
Browns2018concussions <- Browns2018[grep("Concussion", Browns2018$injury),]
...
# removes all rows that dont include a concussion injury
Bengals2018concussions <- Bengals2018[grep("Concussion", Bengals2018$injury),]
...
# removes all rows that dont include a concussion injury
Chiefs2018concussions <- Chiefs2018[grep("Concussion", Chiefs2018$injury),]
...
# removes all rows that dont include a concussion injury
Chargers2018concussions <- Chargers2018[grep("Concussion", Chargers2018$injury),]
...
# removes all rows that dont include a concussion injury
Broncos2018concussions <- Broncos2018[grep("Concussion", Broncos2018$injury),]
...
# removes all rows that dont include a concussion injury
Raiders2018concussions <- Raiders2018[grep("Concussion", Raiders2018$injury),]
...
# removes all rows that dont include a concussion injury
Cowboys2018concussions <- Cowboys2018[grep("Concussion", Cowboys2018$injury),]
...
# removes all rows that dont include a concussion injury
Eagles2018concussions <- Eagles2018[grep("Concussion", Eagles2018$injury),]
...
# removes all rows that dont include a concussion injury
Redskins2018concussions <- Redskins2018[grep("Concussion", Redskins2018$injury),]
...
# removes all rows that dont include a concussion injury
Giants2018concussions <- Giants2018[grep("Concussion", Giants2018$injury),]
Giants2018concussions

# sends to csv file
write.csv(Gaints2018concussions, "Desktop/WebScraping/ConcussionReport/2018/Gaints2018_concussions.csv")
...
# removes all rows that dont include a concussion injury
Saints2018concussions <- Saints2018[grep("Concussion", Saints2018$injury),]
...
# removes all rows that dont include a concussion injury
Falcons2018concussions <- Falcons2018[grep("Concussion", Falcons2018$injury),]
...
# removes all rows that dont include a concussion injury
Panthers2018concussions <- Panthers2018[grep("Concussion", Panthers2018$injury),]
...
# removes all rows that dont include a concussion injury
Buccaneers2018concussions <- Buccaneers2018[grep("Concussion", Buccaneers2018$injury),]
...
# removes all rows that dont include a concussion injury
Bears2018concussions <- Bears2018[grep("Concussion", Bears2018$injury),]
...
# removes all rows that dont include a concussion injury
Vikings2018concussions <- Vikings2018[grep("Concussion", Vikings2018$injury),]
...
# removes all rows that dont include a concussion injury
Packers2018concussions <- Packers2018[grep("Concussion", Packers2018$injury),]
...
# removes all rows that dont include a concussion injury
Lions2018concussions <- Lions2018[grep("Concussion", Lions2018$injury),]
...
# removes all rows that dont include a concussion injury
Rams2018concussions <- Rams2018[grep("Concussion", Rams2018$injury),]
Rams2018concussions
...
# removes all rows that dont include a concussion injury
Seahawks2018concussions <- Seahawks2018[grep("Concussion", Seahawks2018$injury),]
...
# removes all rows that dont include a concussion injury
SanFran2018concussions <- SanFran2018[grep("Concussion", SanFran2018$injury),]
...
# removes all rows that dont include a concussion injury
Cardinals2018concussions <- Cardinals2018[grep("Concussion", Cardinals2018$injury),]
